...
def main():
    ...
    fowarding.insert(b'\xa9\xfe\x63\x00', b'\xff\xff\xff\x00', b'\xa9\xfe\x63\xa1', b'\x01\x01\x00', 0, 1)
    fowarding.insert(b'\xa9\xfe\x1e\x00', b'\xff\xff\xff\x00', b'\xa9\xfe\x1e\xde', b'\x01\x01\x00', 1, 1)
    fowarding.insert(b'\xaa\xbb\xcc\x00', b'\xff\xff\xff\x00', b'\x21\x22\x23\x26', b'\x01\x01\x00', 1, 1)
    fowarding.insert(b'\x00\x11\x22\x00', b'\xff\xff\xff\x00', b'\x31\x32\x33\x36', b'\x01\x01\x00', 1, 1)
    ...
    ni0.getAdapterList()
    input0 = input("[NI0] Input")
    ni0.setAdapter(input0)

    ni1.getAdapterList()
    input1 = input("[NI1] Input")
